...
/** 
 * Класс ChangeTexts для манипуляций с надписями в JLabel.
 * @autor Мария
 * 
*/
public class ChangeTexts {
    ...
    /** 
     * Функция обновления показываемых значений здоровья соперников, их уровней, наносимого урона, полученных очков и того, чей ход на данный момент
     */
    ...
    /** 
     * Функция обновления показываемых значений здоровья соперников и того, чей ход на данный момент
     */
    ...
    /** 
     * Функция, которая обновляет значение текста с информацией о том, на чьей стороне победа
     */
    ...
    /** 
     * Функция, которая обновляет значение текста с информацией о том, сколько вещей есть в запасе у игрока
     */
